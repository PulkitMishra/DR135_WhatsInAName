...
class TopHitsScreen extends StatefulWidget {
  ...
  TopHitsScreen({this.destination});
  TopHitsScreen.fieldConstructor(
      this.monument,
      this.imageUrl,
      this.city,
      this.locality,
  ...
  @override
  TopHitsScreenState createState() => TopHitsScreenState();
}


class TopHitsScreenState extends State<TopHitsScreen> {
  List<Review> reviews = [];
  int lengthOfReviews;
