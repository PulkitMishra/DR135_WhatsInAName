...
class _HomeScreenState extends State<BusHomeScreen> {
  @override
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      ticketDetailsWidget(
                          'Passenger', "Nimish Mishra", 'Date', "2 Aug 2020"),
                      Padding(
                        padding: const EdgeInsets.only(top: 12.0, right: 40.0),
                        child: ticketDetailsWidget(
                            'Bus', widget.bus.busName, 'Rate', widget.bus.price),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(top: 12.0, right: 40.0),
                        child: ticketDetailsWidget(
                            'Class', widget.bus.bus_class, 'Seat', "14"),
                      ),
                    ],
                  ),
                ),
